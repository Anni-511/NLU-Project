...
from transformers import BertTokenizerFast, RobertaTokenizerFast, BertConfig, BertForMaskedLM, RobertaForMaskedLM, DataCollatorForLanguageModeling, TrainingArguments, Trainer
...
def train(args):
		...
		tokenizer = RobertaTokenizerFast.from_pretrained('roberta-base-uncased')
		...
		model = RobertaForMaskedLM.from_pretrained('roberta-base-uncased')
