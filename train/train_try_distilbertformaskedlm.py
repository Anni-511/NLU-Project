...
from transformers import DistilBertTokenizerFast, DistilBertConfig, DistilBertForMaskedLM, DataCollatorForLanguageModeling, TrainingArguments, Trainer
import os
import json
import functools
...
def prepare_dataset():
		files = ["/scratch/rv2138/nlu/data/original_wiki_20.txt", "/scratch/rv2138/nlu/data/swapped_wiki_20.txt"]
